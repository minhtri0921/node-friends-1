...
async function display() {
    ...
    try {
        ...
        var catById = await axios.get(`http://localhost:3000/cat/cat-by-id?id=${cId}`);
        ...
        listElement.append(`<p style='color: red; font-style: italic;'>Xảy ra lỗi khi lấy dữ liệu!<p/>`);
    }
}
display();
